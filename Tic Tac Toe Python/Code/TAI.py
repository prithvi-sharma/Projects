...
# Project by D14A for Open Source Technology.
# Samarth Shahu  - 53
# Prithvi Sharma - 54
...
def main():
    ...
    NEW_SURF, NEW_RECT = makeText(' Player vs AI ', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 150, WINDOWHEIGHT - 80)
    NEW_SURF2, NEW_RECT2 = makeText(' Player vs Human ', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 700, WINDOWHEIGHT - 80)
    board = [BLANK] * 9
    game_over = False
    x_turn = True
    msg = "T-AI - We learn fom you"
    drawBoard(board, msg)
